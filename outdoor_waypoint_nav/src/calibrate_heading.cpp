...
void getParams()
{
    ...
    //get the name for the ouput file path construction
    ros::param::get("/outdoor_waypoint_nav/output_file", output_file);
}
...
int main(int argc, char **argv)
{
    ...
    //write params file
    std::string path =  ros::package::getPath("outdoor_waypoint_nav") + "/params/" + output_file;
